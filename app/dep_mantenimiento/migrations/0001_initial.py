# Generated by Django 4.2.4 on 2024-05-15 16:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puesto', models.CharField(blank=True, choices=[('Empleado', 'Empleado'), ('Secretario', 'Secretario/a'), ('Subdirector', 'Subdirector/a'), ('Docente', 'Docente'), ('Jefe', 'Jefe')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_servicio', models.CharField(blank=True, choices=[('Cerrajería', 'Cerrajería'), ('Electrica', 'Electrica'), ('Pintarrón', 'Pintarrón'), ('Plomería', 'Plomería'), ('Otro', 'Otro'), ('Pintura', 'Pintura'), ('Cañones', 'Cañones'), ('Herrería', 'Herrería')], max_length=100)),
                ...
                ('status', models.CharField(blank=True, choices=[('Realizado', 'Realizado'), ('Rechazado', 'Rechazado'), ('Pendiente', 'Pendiente'), ('En_espera', 'En espera'), ('Solicitud_Firmada', 'Firmado'), ('En_proceso', 'En proceso'), ('Enviado', 'Enviado')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nuevo_status', models.CharField(choices=[('Realizado', 'Realizado'), ('Rechazado', 'Rechazado'), ('Pendiente', 'Pendiente'), ('En_espera', 'En espera'), ('Solicitud_Firmada', 'Firmado'), ('En_proceso', 'En proceso'), ('Enviado', 'Enviado')], max_length=50)),
