    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puesto', models.CharField(blank=True, choices=[('Subdirector', 'Subdirector/a'), ('Jefe', 'Jefe'), ('Empleado', 'Empleado'), ('Secretario', 'Secretario/a'), ('Docente', 'Docente')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_servicio', models.CharField(blank=True, choices=[('Pintarrón', 'Pintarrón'), ('Cerrajería', 'Cerrajería'), ('Plomería', 'Plomería'), ('Otro', 'Otro'), ('Herrería', 'Herrería'), ('Electrica', 'Electrica'), ('Pintura', 'Pintura'), ('Cañones', 'Cañones')], max_length=100)),
                ...
                ('status', models.CharField(blank=True, choices=[('En proceso', 'En proceso'), ('Realizado', 'Realizado'), ('Rechazado', 'Rechazado'), ('En espera', 'En espera'), ('Pendiente', 'Pendiente'), ('Enviado', 'Enviado'), ('Cancelado', 'Cancelado')], max_length=50)),
