    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puesto', models.CharField(blank=True, choices=[('Secretario', 'Secretario/a'), ('Subdirector', 'Subdirector/a'), ('Docente', 'Docente'), ('Empleado', 'Empleado'), ('Jefe', 'Jefe')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_servicio', models.CharField(blank=True, choices=[('Electrica', 'Electrica'), ('Pintarrón', 'Pintarrón'), ('Otro', 'Otro'), ('Herrería', 'Herrería'), ('Pintura', 'Pintura'), ('Cañones', 'Cañones'), ('Cerrajería', 'Cerrajería'), ('Plomería', 'Plomería')], max_length=100)),
                ...
                ('status', models.CharField(blank=True, choices=[('En_espera', 'En espera'), ('En_proceso', 'En proceso'), ('Realizado', 'Realizado'), ('Pendiente', 'Pendiente'), ('Rechazado', 'Rechazado'), ('Solicitud_Firmada', 'Firmado'), ('Enviado', 'Enviado')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora', models.TimeField(blank=True, default=django.utils.timezone.now)),
                ('nuevo_status', models.CharField(choices=[('En_espera', 'En espera'), ('En_proceso', 'En proceso'), ('Realizado', 'Realizado'), ('Pendiente', 'Pendiente'), ('Rechazado', 'Rechazado'), ('Solicitud_Firmada', 'Firmado'), ('Enviado', 'Enviado')], max_length=50)),
