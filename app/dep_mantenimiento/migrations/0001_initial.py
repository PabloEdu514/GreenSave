# Generated by Django 4.2.4 on 2024-05-15 21:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puesto', models.CharField(blank=True, choices=[('Docente', 'Docente'), ('Jefe', 'Jefe'), ('Subdirector', 'Subdirector/a'), ('Secretario', 'Secretario/a'), ('Empleado', 'Empleado')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_servicio', models.CharField(blank=True, choices=[('Cañones', 'Cañones'), ('Plomería', 'Plomería'), ('Herrería', 'Herrería'), ('Electrica', 'Electrica'), ('Pintarrón', 'Pintarrón'), ('Otro', 'Otro'), ('Cerrajería', 'Cerrajería'), ('Pintura', 'Pintura')], max_length=100)),
                ...
                ('status', models.CharField(blank=True, choices=[('En_espera', 'En espera'), ('Enviado', 'Enviado'), ('Realizado', 'Realizado'), ('Pendiente', 'Pendiente'), ('En_proceso', 'En proceso'), ('Rechazado', 'Rechazado'), ('Solicitud_Firmada', 'Firmado')], max_length=50)),
                ...
                ('evidenciasIMG', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evidencias', to='dep_mantenimiento.imagenesevidencias')),
        ...
        migrations.AddField(
            model_name='imagenesevidencias',
            name='solicitud',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='solicitud', to='dep_mantenimiento.solicitud_mantenimiento'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nuevo_status', models.CharField(choices=[('En_espera', 'En espera'), ('Enviado', 'Enviado'), ('Realizado', 'Realizado'), ('Pendiente', 'Pendiente'), ('En_proceso', 'En proceso'), ('Rechazado', 'Rechazado'), ('Solicitud_Firmada', 'Firmado')], max_length=50)),
