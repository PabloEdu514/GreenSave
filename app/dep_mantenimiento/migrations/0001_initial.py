# Generated by Django 4.2.4 on 2024-05-15 04:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puesto', models.CharField(blank=True, choices=[('Subdirector', 'Subdirector/a'), ('Secretario', 'Secretario/a'), ('Jefe', 'Jefe'), ('Docente', 'Docente'), ('Empleado', 'Empleado')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_servicio', models.CharField(blank=True, choices=[('Plomería', 'Plomería'), ('Pintarrón', 'Pintarrón'), ('Herrería', 'Herrería'), ('Electrica', 'Electrica'), ('Pintura', 'Pintura'), ('Cerrajería', 'Cerrajería'), ('Cañones', 'Cañones'), ('Otro', 'Otro')], max_length=100)),
                ...
                ('status', models.CharField(blank=True, choices=[('En_espera', 'En espera'), ('Solicitud_Firmada', 'Firmado'), ('En_proceso', 'En proceso'), ('Pendiente', 'Pendiente'), ('Rechazado', 'Rechazado'), ('Enviado', 'Enviado'), ('Realizado', 'Realizado')], max_length=50)),
                ...
                ('firma_Jefe_VoBo_img', models.ImageField(blank=True, null=True, upload_to='dep_mantenimiento/img')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nuevo_status', models.CharField(choices=[('En_espera', 'En espera'), ('Solicitud_Firmada', 'Firmado'), ('En_proceso', 'En proceso'), ('Pendiente', 'Pendiente'), ('Rechazado', 'Rechazado'), ('Enviado', 'Enviado'), ('Realizado', 'Realizado')], max_length=50)),
