# Generated by Django 4.2.4 on 2024-05-07 05:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puesto', models.CharField(blank=True, choices=[('Secretario', 'Secretario/a'), ('Empleado', 'Empleado'), ('Docente', 'Docente'), ('Subdirector', 'Subdirector/a'), ('Jefe', 'Jefe')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_servicio', models.CharField(blank=True, choices=[('Otro', 'Otro'), ('Pintarrón', 'Pintarrón'), ('Plomería', 'Plomería'), ('Herrería', 'Herrería'), ('Cerrajería', 'Cerrajería'), ('Pintura', 'Pintura'), ('Cañones', 'Cañones'), ('Electrica', 'Electrica')], max_length=100)),
                ...
                ('status', models.CharField(blank=True, choices=[('Pendiente', 'Pendiente'), ('En_espera', 'En espera'), ('Enviado', 'Enviado'), ('Rechazado', 'Rechazado'), ('En_proceso', 'En proceso'), ('Alerta', 'Alerta'), ('Realizado', 'Realizado')], max_length=50)),
