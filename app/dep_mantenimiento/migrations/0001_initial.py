# Generated by Django 4.2.4 on 2024-05-08 03:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puesto', models.CharField(blank=True, choices=[('Empleado', 'Empleado'), ('Docente', 'Docente'), ('Secretario', 'Secretario/a'), ('Subdirector', 'Subdirector/a'), ('Jefe', 'Jefe')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_servicio', models.CharField(blank=True, choices=[('Pintarrón', 'Pintarrón'), ('Cerrajería', 'Cerrajería'), ('Herrería', 'Herrería'), ('Electrica', 'Electrica'), ('Cañones', 'Cañones'), ('Otro', 'Otro'), ('Plomería', 'Plomería'), ('Pintura', 'Pintura')], max_length=100)),
                ...
                ('status', models.CharField(blank=True, choices=[('En_proceso', 'En proceso'), ('Pendiente', 'Pendiente'), ('Realizado', 'Realizado'), ('En_espera', 'En espera'), ('Enviado', 'Enviado'), ('Rechazado', 'Rechazado'), ('Alerta', 'Alerta')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nuevo_status', models.CharField(choices=[('En_proceso', 'En proceso'), ('Pendiente', 'Pendiente'), ('Realizado', 'Realizado'), ('En_espera', 'En espera'), ('Enviado', 'Enviado'), ('Rechazado', 'Rechazado'), ('Alerta', 'Alerta')], max_length=50)),
