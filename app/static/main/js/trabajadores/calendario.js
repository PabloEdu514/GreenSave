    ...
    $.ajax({
        ...
        success: function (data) {
            if (data) {
                ...
                // location.reload()
                setTimeout(function(){
                    window.location.href = '/calendario/DONLEditExito/'
                }, 2000);
            }
        },
        error: function (error) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data) {
                ...
                // location.reload()
                setTimeout(function(){
                    window.location.href = '/calendario/JustEditExito/'
                }, 2000);
            }
        },
        error: function (error) {
...
$('#savePE').on('click', function (e) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data) {
                if(data.name != 'error'){
                    ...
                    setTimeout(function(){
                        window.location.href = '/calendario/PerEditExito/'
                    }, 2000);
                }else{
                    Swal.fire({
        ...
        error: function (error) {
            ...
            setTimeout(function(){
                window.location.href = '/calendario/PerEditError/'
            }, 2000);
        }
    });
});