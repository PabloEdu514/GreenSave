            ...
            if (data) {
                data.forEach(element => {
                    ...
                    <tr>
                       ...
                       <td> 
                          <button type="button" class="btn btn-primary" onclick="getRecordlicencia(` + element.id + ` )" data-bs-toggle="modal" data-target="#modalEditar" > 
                          <i class="fas fa-edit fa-sm"></i>
                          </button>
                          <button button type="button" class="btn btn-danger" onclick="getRecortoDeleteLic(` + element.id + ` )" data-bs-toggle="modal" data-target="#modaleliminarlicencia" > 
                          <i class="fas fa-trash fa-sm"></i>
                          </button>
                       </td>
                    </tr>
...
function getJustificantes() {
    ...
    $.ajax({
        url: "/trabajador/" + id + "/perfil_justificantes",
        type: "get",
        dataType: "json",
        async: false,
        success: function(data) {
